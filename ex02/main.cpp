...
/*   Updated: 2025/12/09 16:34:33 by poverbec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//        mstack.push_back(5);      // Changed from push()
//        mstack.push_back(17);
//        std::cout << mstack.back() << std::endl;  // Changed from top()
//        std::cout << mstack.size() << std::endl;
//        mstack.push_back(3);
//        mstack.push_back(5);
//        mstack.push_back(737);

//        std::cout << "show first element: " << mstack.front() << std::endl;
//        std::cout << "show last element: " << mstack.back() << std::endl;
